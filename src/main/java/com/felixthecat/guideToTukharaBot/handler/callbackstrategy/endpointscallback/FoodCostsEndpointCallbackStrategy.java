...
@Component
public class FoodCostsEndpointCallbackStrategy extends AbstractCallbackStrategy {

    public FoodCostsEndpointCallbackStrategy(ArticleDataRepository articleDataRepository, CallbacksRepository callbacksRepository, UserRepository userRepository) {
        super(articleDataRepository, callbacksRepository, userRepository);
    }

    @Override
    public String getKey() {
        return "Стоимость продуктов";
    }
