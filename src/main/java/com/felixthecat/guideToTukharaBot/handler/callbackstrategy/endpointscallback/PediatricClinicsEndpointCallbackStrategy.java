...
@Component
public class PediatricClinicsEndpointCallbackStrategy extends AbstractCallbackStrategy {

    public PediatricClinicsEndpointCallbackStrategy(ArticleDataRepository articleDataRepository, CallbacksRepository callbacksRepository, UserRepository userRepository) {
