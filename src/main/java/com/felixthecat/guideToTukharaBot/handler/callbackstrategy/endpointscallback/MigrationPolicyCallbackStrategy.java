...
@Component
public class MigrationPolicyCallbackStrategy extends AbstractCallbackStrategy {

    public MigrationPolicyCallbackStrategy(ArticleDataRepository articleDataRepository, CallbacksRepository callbacksRepository, UserRepository userRepository) {
        super(articleDataRepository, callbacksRepository, userRepository);
    }

    @Override
    public String getKey() {
        return "Миграционная политика";
    }
