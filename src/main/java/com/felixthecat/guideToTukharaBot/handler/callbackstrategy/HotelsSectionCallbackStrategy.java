...
@Component
public class HotelsSectionCallbackStrategy extends AbstractCallbackStrategy {

    public HotelsSectionCallbackStrategy(ArticleDataRepository articleDataRepository, CallbacksRepository callbacksRepository, UserRepository userRepository) {
