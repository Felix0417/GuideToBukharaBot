...
@Component
public class MobileConnectionCallbackStrategy extends AbstractCallbackStrategy {

    public MobileConnectionCallbackStrategy(ArticleDataRepository articleDataRepository, CallbacksRepository callbacksRepository, UserRepository userRepository) {
