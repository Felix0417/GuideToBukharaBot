...
@Component
public class ApartmentsRentalCallbackStrategy extends AbstractCallbackStrategy {

    public ApartmentsRentalCallbackStrategy(ArticleDataRepository articleDataRepository, CallbacksRepository callbacksRepository, UserRepository userRepository) {
