...
public class InCityEndpointCallbackStrategy extends AbstractCallbackStrategy {
    ...
    public InCityEndpointCallbackStrategy(ArticleDataRepository articleDataRepository, CallbacksRepository callbacksRepository, UserRepository userRepository) {
