...
@Component
public class DentistClinicsEndpointCallbackStrategy extends AbstractCallbackStrategy {

    public DentistClinicsEndpointCallbackStrategy(ArticleDataRepository articleDataRepository, CallbacksRepository callbacksRepository, UserRepository userRepository) {
