...
@Component
public class GuestHousesEndpointCallbackStrategy extends AbstractCallbackStrategy {

    public GuestHousesEndpointCallbackStrategy(ArticleDataRepository articleDataRepository, CallbacksRepository callbacksRepository, UserRepository userRepository) {
        super(articleDataRepository, callbacksRepository, userRepository);
    }

    @Override
    public String getKey() {
        return "Гостевые_дома";
    }
